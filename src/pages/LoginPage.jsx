      ...
      <div className="w-[60%] min-w-[360px] lg:max-w-[921px] h-[780px] rounded-[10px] bg-gray-primary   px-[10%] semi-lg:px-[100px] flex flex-col">
        ...
        <form className="h-full py-8 semi-lg:py-4 flex flex-col justify-around ">
          ...
          <div className="flex justify-center gap-10">
            <a href="facebook.com"><img src={FacebookLogo} alt="facebook-logo" className="w-[60px] h-[60px]" /></a>
            <a href="gmail.com"><img src={GmailLogo} alt="Gmail-logo" className="w-[60px] h-[60px]" /></a>
          </div>
